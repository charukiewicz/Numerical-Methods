...
This program is a simple fractal generator that utilizes Newton's method to iteratively plot the function and its derivative during the generation of the fractal.

Displays the fractal as a matplotlib graph.
...
newz = []
newr = []
colors = [[0 for x in xrange(multval*2)] for x in xrange(multval*2)]
